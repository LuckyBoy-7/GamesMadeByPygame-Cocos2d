...
class MainMenu(Menu):
    def __init__(self):
        ...
        items = [
            ...
            MenuItem("Option", self.on_option),
...
class OptionMenu(Menu):
    def __init__(self):
        ...
        items = [
            MultipleMenuItem("Level: ", self.on_level, self.level, Settings.input_level - 1),
            ToggleMenuItem("Music: ", self.on_music, Settings.input_music),
            ToggleMenuItem("Sound: ", self.on_sound, Settings.input_sound),
