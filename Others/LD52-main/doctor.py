...
class Doctor:
    ...
    def __init__(self, frame):
        ...
        self.letters = {letter: self.dialog_font.render(letter, 1, (255, 255, 255)) for letter in
                        "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'.,?!|- "}
        self.red_letters = {letter: self.dialog_font.render(letter, 1, (255, 50, 50)) for letter in
                            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'.,?!|- "}
